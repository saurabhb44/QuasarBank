...
var _RecommendationTrends = _interopRequireDefault(require("../model/RecommendationTrends"));

var _RevenueEstimates = _interopRequireDefault(require("../model/RevenueEstimates"));

var _Splits = _interopRequireDefault(require("../model/Splits"));
...
var DefaultApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(DefaultApi, [{
    ...
    key: "cryptoCandles",
    value: function cryptoCandles(symbol, resolution, opts, callback) {
      opts = opts || {};
      var postBody = null; // verify the required parameter 'symbol' is set
    ...
    value: function earningsCalendar(opts, callback) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = [_EarningRelease["default"]];
    ...
    key: "forexCandles",
    value: function forexCandles(symbol, resolution, opts, callback) {
      opts = opts || {};
      var postBody = null; // verify the required parameter 'symbol' is set
    ...
    value: function ipoCalendar(from, to, callback) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = [_IPOEvent["default"]];
    ...
    value: function recommendationTrends(symbol, callback) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _RecommendationTrends["default"];
    ...
    key: "stockCandles",
    value: function stockCandles(symbol, resolution, opts, callback) {
      opts = opts || {};
      var postBody = null; // verify the required parameter 'symbol' is set
    ...
    value: function stockSplits(symbol, from, to, callback) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _Splits["default"];
